...
let info = getFragmentInfo('../tstream/frags/0.mp4');
...
info = getFragmentInfo('../tstream/frags/1.mp4');
frags.push(MP4Generator.fragmentSegment(48000, info[0], info[0].mdat));

info = getFragmentInfo('../tstream/frags/2.mp4');
frags.push(MP4Generator.fragmentSegment(48000 * 2, info[0], info[0].mdat));

info = getFragmentInfo('../tstream/frags/3.mp4');
frags.push(MP4Generator.fragmentSegment(48000 * 3, info[0], info[0].mdat));


info = getFragmentInfo('../tstream/frags/4.mp4');
frags.push(MP4Generator.fragmentSegment(48000 * 4, info[0], info[0].mdat));
